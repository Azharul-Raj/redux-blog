...
const ReadingCard = ({ content }) => {
      // 
    const dispatch=useDispatch()
    return (
        <Link key={content._id} onClick={() =>dispatch(addReadingCount(content)) } to={`/content/${content._id}`} className="p-10 flex justify-center items-center">
